...
function gotResult(error, results){
    if(error){
        ...
        console.log(results);
        document.getElementById("family_member_object").innerHTML = results[0].label;
        document.getElementById("family_accuracy_object").innerHTML = results[0].confidence.toFixed(3);
    }
}